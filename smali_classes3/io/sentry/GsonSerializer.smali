...
.method private provideGson()Lcom/google/gson/Gson;
    ...
    iget-object v7, p0, Lio/sentry/GsonSerializer;->logger:Lio/sentry/ILogger;

    invoke-direct {v6, v7}, Lio/sentry/adapters/SentryIdSerializerAdapter;-><init>(Lio/sentry/ILogger;)V
    ...
    invoke-direct {v6, v7}, Lio/sentry/adapters/SentryIdDeserializerAdapter;-><init>(Lio/sentry/ILogger;)V
    ...
    invoke-direct {v6, v7}, Lio/sentry/adapters/DateSerializerAdapter;-><init>(Lio/sentry/ILogger;)V
    ...
    invoke-direct {v6, v7}, Lio/sentry/adapters/DateDeserializerAdapter;-><init>(Lio/sentry/ILogger;)V
    ...
    invoke-direct {v6, v7}, Lio/sentry/adapters/TimeZoneSerializerAdapter;-><init>(Lio/sentry/ILogger;)V
    ...
    invoke-direct {v6, v7}, Lio/sentry/adapters/TimeZoneDeserializerAdapter;-><init>(Lio/sentry/ILogger;)V
    ...
    iget-object v6, p0, Lio/sentry/GsonSerializer;->logger:Lio/sentry/ILogger;

    invoke-direct {v5, v6}, Lio/sentry/adapters/OrientationSerializerAdapter;-><init>(Lio/sentry/ILogger;)V
    ...
    invoke-direct {v5, v6}, Lio/sentry/adapters/OrientationDeserializerAdapter;-><init>(Lio/sentry/ILogger;)V
    ...
    iget-object v5, p0, Lio/sentry/GsonSerializer;->logger:Lio/sentry/ILogger;

    invoke-direct {v4, v5}, Lio/sentry/adapters/SentryLevelSerializerAdapter;-><init>(Lio/sentry/ILogger;)V
    ...
    invoke-direct {v4, v5}, Lio/sentry/adapters/SentryLevelDeserializerAdapter;-><init>(Lio/sentry/ILogger;)V
    ...
    invoke-direct {v4, v5}, Lio/sentry/adapters/ContextsDeserializerAdapter;-><init>(Lio/sentry/ILogger;)V
    ...
    invoke-direct {v4, v5}, Lio/sentry/adapters/ContextsSerializerAdapter;-><init>(Lio/sentry/ILogger;)V
    ...
    invoke-direct {v4, v5}, Lio/sentry/SessionAdapter;-><init>(Lio/sentry/ILogger;)V
    ...
    invoke-direct {v3, v4}, Lio/sentry/adapters/SpanIdDeserializerAdapter;-><init>(Lio/sentry/ILogger;)V
    ...
    invoke-direct {v3, v4}, Lio/sentry/adapters/SpanIdSerializerAdapter;-><init>(Lio/sentry/ILogger;)V
