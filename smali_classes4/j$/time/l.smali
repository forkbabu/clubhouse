...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lj$/time/l;->b:Ljava/util/concurrent/ConcurrentMap;

    new-instance v0, Ljava/util/concurrent/ConcurrentHashMap;

    invoke-direct {v0, v1, v2, v3}, Ljava/util/concurrent/ConcurrentHashMap;-><init>(IFI)V

    sput-object v0, Lj$/time/l;->c:Ljava/util/concurrent/ConcurrentMap;
...
.method private constructor <init>(I)V
    ...
    .line 2
    :goto_4
    iput-object p1, p0, Lj$/time/l;->h:Ljava/lang/String;
...
.method public static S(Ljava/lang/String;)Lj$/time/l;
    .locals 7
    ...
    sget-object v0, Lj$/time/l;->c:Ljava/util/concurrent/ConcurrentMap;
    ...
    invoke-static {p0, v2, v3}, Lj$/time/l;->X(Ljava/lang/CharSequence;IZ)I

    move-result v0

    invoke-static {p0, v6, v2}, Lj$/time/l;->X(Ljava/lang/CharSequence;IZ)I

    move-result v1

    invoke-static {p0, v5, v2}, Lj$/time/l;->X(Ljava/lang/CharSequence;IZ)I
    ...
    invoke-static {p0, v1, v3}, Lj$/time/l;->X(Ljava/lang/CharSequence;IZ)I

    move-result v1

    invoke-static {p0, v4, v3}, Lj$/time/l;->X(Ljava/lang/CharSequence;IZ)I
    ...
    invoke-static {p0, v0, v1}, Lj$/time/l;->V(III)Lj$/time/l;
    ...
    :cond_9
    invoke-static {v0, v1, v2}, Lj$/time/l;->V(III)Lj$/time/l;
...
.method public static V(III)Lj$/time/l;
    .locals 4
...
.method public static W(I)Lj$/time/l;
    .locals 3
    ...
    sget-object v1, Lj$/time/l;->b:Ljava/util/concurrent/ConcurrentMap;
    ...
    invoke-direct {v2, p0}, Lj$/time/l;-><init>(I)V
    ...
    sget-object p0, Lj$/time/l;->c:Ljava/util/concurrent/ConcurrentMap;

    .line 1
    iget-object v0, v2, Lj$/time/l;->h:Ljava/lang/String;
    ...
    invoke-direct {v0, p0}, Lj$/time/l;-><init>(I)V
...
.method private static X(Ljava/lang/CharSequence;IZ)I
    .locals 2
...
.method public j(Lj$/time/temporal/r;)I
    ...
    .line 2
    invoke-virtual {p0, p1}, Lj$/time/l;->g(Lj$/time/temporal/r;)J
...
.method public n()Lj$/time/zone/c;
    .locals 1

    invoke-static {p0}, Lj$/time/zone/c;->j(Lj$/time/l;)Lj$/time/zone/c;
...
.method public r()Ljava/lang/String;
    ...
    iget-object v0, p0, Lj$/time/l;->h:Ljava/lang/String;
