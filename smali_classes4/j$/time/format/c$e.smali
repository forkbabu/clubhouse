.class final Lj$/time/format/c$e;
...
# direct methods
.method constructor <init>(Lj$/time/temporal/r;IIZ)V
    .locals 2
    ...
    invoke-virtual {v0}, Lj$/time/temporal/w;->f()Z
    ...
    iput-object p1, p0, Lj$/time/format/c$e;->a:Lj$/time/temporal/r;

    iput p2, p0, Lj$/time/format/c$e;->b:I

    iput p3, p0, Lj$/time/format/c$e;->c:I

    iput-boolean p4, p0, Lj$/time/format/c$e;->d:Z
...
.method public m(Lj$/time/format/g;Ljava/lang/StringBuilder;)Z
    ...
    iget-object v0, p0, Lj$/time/format/c$e;->a:Lj$/time/temporal/r;
    ...
    invoke-interface {v0}, Lj$/time/temporal/r;->y()Lj$/time/temporal/w;

    move-result-object v0

    iget-object v4, p0, Lj$/time/format/c$e;->a:Lj$/time/temporal/r;

    invoke-virtual {v0, v2, v3, v4}, Lj$/time/temporal/w;->b(JLj$/time/temporal/r;)J
    ...
    iget v0, p0, Lj$/time/format/c$e;->b:I

    if-lez v0, :cond_5

    iget-boolean v0, p0, Lj$/time/format/c$e;->d:Z

    if-eqz v0, :cond_2

    invoke-virtual {p1}, Lj$/time/format/i;->c()C
    ...
    iget v2, p0, Lj$/time/format/c$e;->b:I

    invoke-static {v1, v2}, Ljava/lang/Math;->max(II)I

    move-result v1

    iget v2, p0, Lj$/time/format/c$e;->c:I
    ...
    iget-boolean v1, p0, Lj$/time/format/c$e;->d:Z
...
.method public n(Lj$/time/format/d;Ljava/lang/CharSequence;I)I
    ...
    :cond_3
    iget-boolean v4, p0, Lj$/time/format/c$e;->d:Z
    ...
    invoke-virtual {p1}, Lj$/time/format/d;->g()Lj$/time/format/i;

    move-result-object v5

    invoke-virtual {v5}, Lj$/time/format/i;->c()C
    ...
    invoke-virtual {v5, v2}, Lj$/time/format/i;->b(C)I
    ...
    .line 1
    iget-object p3, p0, Lj$/time/format/c$e;->a:Lj$/time/temporal/r;

    invoke-interface {p3}, Lj$/time/temporal/r;->y()Lj$/time/temporal/w;
    ...
    .line 2
    iget-object v5, p0, Lj$/time/format/c$e;->a:Lj$/time/temporal/r;
...
.method public toString()Ljava/lang/String;
    ...
    iget-object v2, p0, Lj$/time/format/c$e;->a:Lj$/time/temporal/r;
    ...
    iget v3, p0, Lj$/time/format/c$e;->b:I
