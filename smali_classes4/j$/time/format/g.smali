...
.method constructor <init>(Lj$/time/temporal/n;Lj$/time/format/DateTimeFormatter;)V
    ...
    invoke-interface {p1, v2}, Lj$/time/temporal/n;->d(Lj$/time/temporal/t;)Ljava/lang/Object;
    ...
    invoke-interface {p1, v3}, Lj$/time/temporal/n;->d(Lj$/time/temporal/t;)Ljava/lang/Object;
    ...
    invoke-interface {p1, v6}, Lj$/time/temporal/n;->f(Lj$/time/temporal/r;)Z
    ...
    :goto_1
    invoke-static {p1}, Lj$/time/Instant;->y(Lj$/time/temporal/n;)Lj$/time/Instant;

    move-result-object p1

    invoke-interface {v4, p1, v1}, Lj$/time/chrono/h;->u(Lj$/time/Instant;Lj$/time/ZoneId;)Lj$/time/chrono/f;
    ...
    :cond_6
    :try_start_0
    invoke-virtual {v1}, Lj$/time/ZoneId;->n()Lj$/time/zone/c;
    ...
    invoke-virtual {v6, v7}, Lj$/time/zone/c;->d(Lj$/time/Instant;)Lj$/time/l;
    ...
    invoke-interface {p1, v6}, Lj$/time/temporal/n;->j(Lj$/time/temporal/r;)I
    ...
    invoke-virtual {v7, v8}, Lj$/time/zone/c;->d(Lj$/time/Instant;)Lj$/time/l;

    move-result-object v7

    invoke-virtual {v7}, Lj$/time/l;->M()I
    ...
    invoke-interface {v4, p1}, Lj$/time/chrono/h;->s(Lj$/time/temporal/n;)Lj$/time/chrono/b;
    ...
    invoke-virtual {v7}, Lj$/time/temporal/j;->m()Z
    ...
    invoke-direct {v0, v5, p1, v4, v3}, Lj$/time/format/f;-><init>(Lj$/time/chrono/b;Lj$/time/temporal/n;Lj$/time/chrono/h;Lj$/time/ZoneId;)V

    move-object p1, v0

    .line 4
    :goto_7
    iput-object p1, p0, Lj$/time/format/g;->a:Lj$/time/temporal/n;
...
.method d()Lj$/time/temporal/n;
    .locals 1

    iget-object v0, p0, Lj$/time/format/g;->a:Lj$/time/temporal/n;

    return-object v0
.end method

.method e(Lj$/time/temporal/r;)Ljava/lang/Long;
    .locals 2
...
.method f(Lj$/time/temporal/t;)Ljava/lang/Object;
    .locals 2
    ...
    iget-object v1, p0, Lj$/time/format/g;->a:Lj$/time/temporal/n;
