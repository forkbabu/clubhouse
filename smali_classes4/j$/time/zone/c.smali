...
.field private static final c:[Lj$/time/g;
...
.field private final f:[Lj$/time/l;

.field private final g:[J

.field private final h:[Lj$/time/g;

.field private final i:[Lj$/time/l;
...
.method static constructor <clinit>()V
    ...
    sput-object v1, Lj$/time/zone/c;->c:[Lj$/time/g;
...
.method private constructor <init>(Lj$/time/l;)V
    .locals 2
    ...
    iput-object v0, p0, Lj$/time/zone/c;->f:[Lj$/time/l;
    ...
    sget-object p1, Lj$/time/zone/c;->c:[Lj$/time/g;

    iput-object p1, p0, Lj$/time/zone/c;->h:[Lj$/time/g;

    iput-object v0, p0, Lj$/time/zone/c;->i:[Lj$/time/l;
...
.method constructor <init>(Ljava/util/TimeZone;)V
    ...
    invoke-static {v1}, Lj$/time/zone/c;->k(I)Lj$/time/l;
    ...
    sget-object v1, Lj$/time/zone/c;->c:[Lj$/time/g;

    iput-object v1, p0, Lj$/time/zone/c;->h:[Lj$/time/g;
...
.method private a(Lj$/time/g;Lj$/time/zone/a;)Ljava/lang/Object;
    .locals 2

    invoke-virtual {p2}, Lj$/time/zone/a;->n()Lj$/time/g;

    move-result-object v0

    invoke-virtual {p2}, Lj$/time/zone/a;->M()Z

    move-result v1

    invoke-virtual {p1, v0}, Lj$/time/g;->X(Lj$/time/chrono/d;)Z
    ...
    invoke-virtual {p2}, Lj$/time/zone/a;->E()Lj$/time/l;
    ...
    :cond_0
    invoke-virtual {p2}, Lj$/time/zone/a;->m()Lj$/time/g;
...
.method private b(I)[Lj$/time/zone/a;
    ...
    invoke-static {v3, v6, v7, v5, v5}, Lj$/time/g;->Y(IIIII)Lj$/time/g;

    move-result-object v3

    iget-object v6, v0, Lj$/time/zone/c;->f:[Lj$/time/l;

    aget-object v5, v6, v5

    invoke-interface {v3, v5}, Lj$/time/chrono/d;->U(Lj$/time/l;)J
    ...
    :goto_3
    invoke-static {v3}, Lj$/time/zone/c;->k(I)Lj$/time/l;
    ...
    invoke-static {v4}, Lj$/time/zone/c;->k(I)Lj$/time/l;

    move-result-object v7

    invoke-direct {v0, v5, v6, v7}, Lj$/time/zone/c;->c(JLj$/time/l;)I
    ...
    invoke-direct {v12, v5, v6, v3, v7}, Lj$/time/zone/a;-><init>(JLj$/time/l;Lj$/time/l;)V
...
.method private c(JLj$/time/l;)I
    ...
    invoke-virtual {p1}, Lj$/time/f;->S()I
...
.method private e(Lj$/time/g;)Ljava/lang/Object;
    .locals 6
    ...
    iget-object v1, p0, Lj$/time/zone/c;->f:[Lj$/time/l;

    aget-object v1, v1, v2

    invoke-interface {p1, v1}, Lj$/time/chrono/d;->U(Lj$/time/l;)J
    ...
    invoke-static {p1}, Lj$/time/zone/c;->k(I)Lj$/time/l;
    ...
    invoke-direct {p0, p1, v1}, Lj$/time/zone/c;->a(Lj$/time/g;Lj$/time/zone/a;)Ljava/lang/Object;
    ...
    invoke-virtual {v1}, Lj$/time/zone/a;->E()Lj$/time/l;
    ...
    iget-object p1, p0, Lj$/time/zone/c;->f:[Lj$/time/l;
    ...
    iget-object v0, p0, Lj$/time/zone/c;->h:[Lj$/time/g;
    ...
    invoke-virtual {p1, v0}, Lj$/time/g;->W(Lj$/time/chrono/d;)Z
    ...
    iget-object p1, p0, Lj$/time/zone/c;->i:[Lj$/time/l;
    ...
    iget-object v2, p0, Lj$/time/zone/c;->i:[Lj$/time/l;
    ...
    invoke-virtual {v3}, Lj$/time/l;->M()I
    ...
    invoke-direct {v0, v1, v3, p1}, Lj$/time/zone/a;-><init>(Lj$/time/g;Lj$/time/l;Lj$/time/l;)V
    ...
    invoke-direct {v1, v0, v3, p1}, Lj$/time/zone/a;-><init>(Lj$/time/g;Lj$/time/l;Lj$/time/l;)V

    return-object v1

    :cond_e
    iget-object v0, p0, Lj$/time/zone/c;->i:[Lj$/time/l;
...
.method public static j(Lj$/time/l;)Lj$/time/zone/c;
    .locals 1

    new-instance v0, Lj$/time/zone/c;

    invoke-direct {v0, p0}, Lj$/time/zone/c;-><init>(Lj$/time/l;)V

    return-object v0
.end method

.method private static k(I)Lj$/time/l;
    .locals 0

    div-int/lit16 p0, p0, 0x3e8

    invoke-static {p0}, Lj$/time/l;->W(I)Lj$/time/l;
...
# virtual methods
.method public d(Lj$/time/Instant;)Lj$/time/l;
    .locals 6
    ...
    invoke-direct {p0, v2, v3, p1}, Lj$/time/zone/c;->c(JLj$/time/l;)I
    ...
    invoke-virtual {v0}, Lj$/time/zone/a;->E()Lj$/time/l;
    ...
    :cond_3
    invoke-virtual {v0}, Lj$/time/zone/a;->y()Lj$/time/l;
...
.method public equals(Ljava/lang/Object;)Z
    ...
    iget-object v3, p1, Lj$/time/zone/c;->f:[Lj$/time/l;
    ...
    iget-object v1, p0, Lj$/time/zone/c;->i:[Lj$/time/l;

    iget-object v3, p1, Lj$/time/zone/c;->i:[Lj$/time/l;
...
.method public f(Lj$/time/g;)Lj$/time/zone/a;
    .locals 1

    invoke-direct {p0, p1}, Lj$/time/zone/c;->e(Lj$/time/g;)Ljava/lang/Object;
...
.method public g(Lj$/time/g;)Ljava/util/List;
    .locals 1
...
.method public h(Lj$/time/Instant;)Z
    ...
    invoke-static {v0}, Lj$/time/zone/c;->k(I)Lj$/time/l;
    ...
    iget-object v0, p0, Lj$/time/zone/c;->f:[Lj$/time/l;
    ...
    iget-object v2, p0, Lj$/time/zone/c;->e:[J
    ...
    .line 2
    :goto_0
    invoke-virtual {p0, p1}, Lj$/time/zone/c;->d(Lj$/time/Instant;)Lj$/time/l;
...
.method public i()Z
    ...
    invoke-virtual {v1}, Lj$/time/Instant;->E()I
    ...
    invoke-direct {v0, v10, v11, v1}, Lj$/time/zone/c;->c(JLj$/time/l;)I
    ...
    invoke-virtual {v1}, Lj$/time/b;->c()J
    ...
    invoke-static {v4, v3, v3}, Lj$/time/f;->W(III)Lj$/time/f;

    move-result-object v4

    invoke-virtual {v4}, Lj$/time/f;->t()J
    ...
    invoke-direct {v0, v5, v6, v1}, Lj$/time/zone/c;->c(JLj$/time/l;)I
    ...
    iget-object v1, v0, Lj$/time/zone/c;->i:[Lj$/time/l;
    ...
    :cond_d
    invoke-direct {v0, v4, v5, v1}, Lj$/time/zone/c;->c(JLj$/time/l;)I
    ...
    iget-object v4, v0, Lj$/time/zone/c;->i:[Lj$/time/l;

    aget-object v5, v4, v5

    aget-object v1, v4, v1

    invoke-direct {v9, v6, v7, v5, v1}, Lj$/time/zone/a;-><init>(JLj$/time/l;Lj$/time/l;)V
...
.method public toString()Ljava/lang/String;
    ...
    iget-object v2, p0, Lj$/time/zone/c;->f:[Lj$/time/l;
