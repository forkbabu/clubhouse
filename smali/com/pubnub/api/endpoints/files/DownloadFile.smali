.class public Lcom/pubnub/api/endpoints/files/DownloadFile;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/pubnub/api/endpoints/files/DownloadFile$Builder;
    }
.end annotation
...
.method public static builder(Lcom/pubnub/api/PubNub;Lcom/pubnub/api/managers/TelemetryManager;Lcom/pubnub/api/managers/RetrofitManager;)Lcom/pubnub/api/endpoints/files/DownloadFile$Builder;
    .locals 2

    .line 1
    new-instance v0, Lcom/pubnub/api/endpoints/files/DownloadFile$Builder;

    new-instance v1, Ld0/n/a/a/a/b;

    invoke-direct {v1, p0, p1, p2}, Ld0/n/a/a/a/b;-><init>(Lcom/pubnub/api/PubNub;Lcom/pubnub/api/managers/TelemetryManager;Lcom/pubnub/api/managers/RetrofitManager;)V
    ...
    invoke-direct {v0, p0, p1}, Lcom/pubnub/api/endpoints/files/DownloadFile$Builder;-><init>(Lcom/pubnub/api/endpoints/BuilderSteps$ChannelStep;Lcom/pubnub/api/endpoints/files/DownloadFile$1;)V
...
# virtual methods
.method public cipherKey(Ljava/lang/String;)Lcom/pubnub/api/endpoints/files/DownloadFile;
    .locals 0

    .line 1
    iput-object p1, p0, Lcom/pubnub/api/endpoints/files/DownloadFile;->cipherKey:Ljava/lang/String;

    return-object p0
.end method

.method public createResponse(Lf1/v;)Lcom/pubnub/api/models/consumer/files/PNDownloadFileResult;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iget-object v1, p0, Lcom/pubnub/api/endpoints/files/DownloadFile;->cipherKey:Ljava/lang/String;

    invoke-static {v0, v1}, Lcom/pubnub/api/vendor/FileEncryptionUtil;->effectiveCipherKey(Lcom/pubnub/api/PubNub;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {p1}, Lc1/f0;->byteStream()Ljava/io/InputStream;
    ...
    invoke-static {v0, p1}, Lcom/pubnub/api/vendor/FileEncryptionUtil;->decrypt(Ljava/lang/String;Ljava/io/InputStream;)Ljava/io/InputStream;
...
.method public bridge synthetic createResponse(Lf1/v;)Ljava/lang/Object;
    ...
    .line 1
    invoke-virtual {p0, p1}, Lcom/pubnub/api/endpoints/files/DownloadFile;->createResponse(Lf1/v;)Lcom/pubnub/api/models/consumer/files/PNDownloadFileResult;
...
.method public doWork(Ljava/util/Map;)Lf1/d;
    ...
    invoke-interface/range {v1 .. v6}, Lcom/pubnub/api/services/FilesService;->downloadFile(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/util/Map;)Lf1/d;
