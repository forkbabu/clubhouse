.class public final Lcom/pubnub/api/endpoints/objects_api/channel/GetChannelMetadataCommand;
.super Lcom/pubnub/api/endpoints/objects_api/channel/GetChannelMetadata;
...
.method public constructor <init>(Ljava/lang/String;Lcom/pubnub/api/PubNub;Lcom/pubnub/api/managers/TelemetryManager;Lcom/pubnub/api/managers/RetrofitManager;Lcom/pubnub/api/endpoints/objects_api/CompositeParameterEnricher;)V
    ...
    .line 1
    invoke-direct/range {p0 .. p5}, Lcom/pubnub/api/endpoints/objects_api/channel/GetChannelMetadata;-><init>(Ljava/lang/String;Lcom/pubnub/api/PubNub;Lcom/pubnub/api/managers/TelemetryManager;Lcom/pubnub/api/managers/RetrofitManager;Lcom/pubnub/api/endpoints/objects_api/CompositeParameterEnricher;)V
...
# virtual methods
.method public createResponse(Lf1/v;)Lcom/pubnub/api/models/consumer/objects_api/channel/PNGetChannelMetadataResult;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 3
    new-instance v0, Lcom/pubnub/api/models/consumer/objects_api/channel/PNGetChannelMetadataResult;

    check-cast p1, Lcom/pubnub/api/models/server/objects_api/EntityEnvelope;

    invoke-direct {v0, p1}, Lcom/pubnub/api/models/consumer/objects_api/channel/PNGetChannelMetadataResult;-><init>(Lcom/pubnub/api/models/server/objects_api/EntityEnvelope;)V

    return-object v0

    .line 4
    :cond_0
    new-instance p1, Lcom/pubnub/api/models/consumer/objects_api/channel/PNGetChannelMetadataResult;

    invoke-direct {p1}, Lcom/pubnub/api/models/consumer/objects_api/channel/PNGetChannelMetadataResult;-><init>()V
...
.method public bridge synthetic createResponse(Lf1/v;)Ljava/lang/Object;
    ...
    .line 1
    invoke-virtual {p0, p1}, Lcom/pubnub/api/endpoints/objects_api/channel/GetChannelMetadataCommand;->createResponse(Lf1/v;)Lcom/pubnub/api/models/consumer/objects_api/channel/PNGetChannelMetadataResult;
...
.method public executeCommand(Ljava/util/Map;)Lf1/d;
    ...
    invoke-interface {v0, v1, v2, p1}, Lcom/pubnub/api/services/ChannelMetadataService;->getChannelMetadata(Ljava/lang/String;Ljava/lang/String;Ljava/util/Map;)Lf1/d;
...
.method public getOperationType()Lcom/pubnub/api/enums/PNOperationType;
    ...
    .line 1
    sget-object v0, Lcom/pubnub/api/enums/PNOperationType;->PNGetChannelMetadataOperation:Lcom/pubnub/api/enums/PNOperationType;
