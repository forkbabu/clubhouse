.class public final Lcom/pubnub/api/endpoints/objects_api/members/SetChannelMembersCommand;
.super Lcom/pubnub/api/endpoints/objects_api/members/SetChannelMembers;
...
.method public constructor <init>(Ljava/lang/String;Ljava/util/Collection;Lcom/pubnub/api/PubNub;Lcom/pubnub/api/managers/TelemetryManager;Lcom/pubnub/api/managers/RetrofitManager;Lcom/pubnub/api/endpoints/objects_api/CompositeParameterEnricher;)V
    ...
    .line 1
    invoke-direct/range {v0 .. v5}, Lcom/pubnub/api/endpoints/objects_api/members/SetChannelMembers;-><init>(Ljava/lang/String;Lcom/pubnub/api/PubNub;Lcom/pubnub/api/managers/TelemetryManager;Lcom/pubnub/api/managers/RetrofitManager;Lcom/pubnub/api/endpoints/objects_api/CompositeParameterEnricher;)V

    .line 2
    iput-object p2, p0, Lcom/pubnub/api/endpoints/objects_api/members/SetChannelMembersCommand;->uuids:Ljava/util/Collection;
...
# virtual methods
.method public createResponse(Lf1/v;)Lcom/pubnub/api/models/consumer/objects_api/member/PNSetChannelMembersResult;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 3
    new-instance v0, Lcom/pubnub/api/models/consumer/objects_api/member/PNSetChannelMembersResult;

    check-cast p1, Lcom/pubnub/api/models/server/objects_api/EntityArrayEnvelope;

    invoke-direct {v0, p1}, Lcom/pubnub/api/models/consumer/objects_api/member/PNSetChannelMembersResult;-><init>(Lcom/pubnub/api/models/server/objects_api/EntityArrayEnvelope;)V

    return-object v0

    .line 4
    :cond_0
    new-instance p1, Lcom/pubnub/api/models/consumer/objects_api/member/PNSetChannelMembersResult;

    invoke-direct {p1}, Lcom/pubnub/api/models/consumer/objects_api/member/PNSetChannelMembersResult;-><init>()V
...
.method public bridge synthetic createResponse(Lf1/v;)Ljava/lang/Object;
    ...
    .line 1
    invoke-virtual {p0, p1}, Lcom/pubnub/api/endpoints/objects_api/members/SetChannelMembersCommand;->createResponse(Lf1/v;)Lcom/pubnub/api/models/consumer/objects_api/member/PNSetChannelMembersResult;
...
.method public executeCommand(Ljava/util/Map;)Lf1/d;
    ...
    iget-object v1, p0, Lcom/pubnub/api/endpoints/objects_api/members/SetChannelMembersCommand;->uuids:Ljava/util/Collection;
...
.method public getOperationType()Lcom/pubnub/api/enums/PNOperationType;
    ...
    .line 1
    sget-object v0, Lcom/pubnub/api/enums/PNOperationType;->PNSetChannelMembersOperation:Lcom/pubnub/api/enums/PNOperationType;
