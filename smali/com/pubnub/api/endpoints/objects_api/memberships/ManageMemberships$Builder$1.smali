.class public Lcom/pubnub/api/endpoints/objects_api/memberships/ManageMemberships$Builder$1;
.super Ljava/lang/Object;
.source "ManageMemberships.java"

# interfaces
.implements Lcom/pubnub/api/endpoints/objects_api/utils/ObjectsBuilderSteps$RemoveOrSetStep$RemoveStep;


# annotations
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Lcom/pubnub/api/endpoints/objects_api/memberships/ManageMemberships$Builder;->set(Ljava/util/Collection;)Lcom/pubnub/api/endpoints/objects_api/utils/ObjectsBuilderSteps$RemoveOrSetStep$RemoveStep;
.end annotation
...
.field public final synthetic val$channelsToSet:Ljava/util/Collection;
...
.method public constructor <init>(Lcom/pubnub/api/endpoints/objects_api/memberships/ManageMemberships$Builder;Ljava/util/Collection;)V
    ...
    .line 1
    iput-object p1, p0, Lcom/pubnub/api/endpoints/objects_api/memberships/ManageMemberships$Builder$1;->this$0:Lcom/pubnub/api/endpoints/objects_api/memberships/ManageMemberships$Builder;

    iput-object p2, p0, Lcom/pubnub/api/endpoints/objects_api/memberships/ManageMemberships$Builder$1;->val$channelsToSet:Ljava/util/Collection;
...
# virtual methods
.method public remove(Ljava/util/Collection;)Lcom/pubnub/api/endpoints/objects_api/memberships/ManageMemberships;
    .locals 8
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iget-object v1, p0, Lcom/pubnub/api/endpoints/objects_api/memberships/ManageMemberships$Builder$1;->val$channelsToSet:Ljava/util/Collection;

    iget-object v0, p0, Lcom/pubnub/api/endpoints/objects_api/memberships/ManageMemberships$Builder$1;->this$0:Lcom/pubnub/api/endpoints/objects_api/memberships/ManageMemberships$Builder;
...
.method public bridge synthetic remove(Ljava/util/Collection;)Ljava/lang/Object;
    .locals 0

    .line 1
    invoke-virtual {p0, p1}, Lcom/pubnub/api/endpoints/objects_api/memberships/ManageMemberships$Builder$1;->remove(Ljava/util/Collection;)Lcom/pubnub/api/endpoints/objects_api/memberships/ManageMemberships;
