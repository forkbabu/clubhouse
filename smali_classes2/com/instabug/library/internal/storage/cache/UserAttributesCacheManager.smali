...
.method public static getAll()Ljava/util/HashMap;
    ...
    .line 3
    invoke-virtual {v0}, Lcom/instabug/library/model/UserAttributes;->getMap()Ljava/util/HashMap;
...
.method public static getCache()Lcom/instabug/library/internal/storage/cache/InMemoryCache;
    ...
    invoke-virtual {v0, v3}, Lcom/instabug/library/internal/storage/cache/CacheManager;->getCache(Ljava/lang/String;)Lcom/instabug/library/internal/storage/cache/Cache;
...
.method private static prepareUserAttributesCache(Landroid/content/Context;)V
    ...
    const-class v1, Lcom/instabug/library/model/UserAttributes;

    const-string v2, "user_attributes_disk_cache"

    const-string v3, "/user_attributes.cache"

    invoke-direct {v0, p0, v2, v3, v1}, Lcom/instabug/library/internal/storage/cache/OnDiskCache;-><init>(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Ljava/lang/Class;)V
